...
This notice applies only to original project materials. The bundled City of Chicago data remains subject to the source publisher's terms. See [LICENSE.md](LICENSE.md).